...
public class GetPantryItemData implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        ...
        PantryLambdaService lambdaService = serviceComponent.providePantryLambdaService();
        ...
        try {
            PantryData pantryData = lambdaService.getPantryData(pantryItemId);
